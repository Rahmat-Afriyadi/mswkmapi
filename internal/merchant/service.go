...
func (s *mstMtrService) MasterData(search string, kategori string, limit int, pageParams int) []Merchant {
	return s.trR.MasterData(search, kategori, limit, pageParams)
}
