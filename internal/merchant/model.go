...
type Merchant struct {
	...
	ValidFrom    time.Time             `form:"valid_from" json:"valid_from" gorm:"column:valid_from"`
	ValidThru    time.Time             `form:"valid_thru" json:"valid_thru" gorm:"column:valid_thru"`
	Logo         string                `form:"logo" json:"logo" gorm:"type:varchar(100);column:logo"`
	Kategori     []entity.Kategori     `json:"kategori" gorm:"many2many:merchant_kategori;"`
	...
	MediaPromosi []entity.MediaPromosi `json:"media_promosi" gorm:"many2many:merchant_media_promosi;"`
	Deskripsi    string                `form:"deskripsi" json:"deskripsi" gorm:"column:deskripsi;"`
	NamaPICMRO   []entity.PicMro       `json:"nama_pic_mro" gorm:"many2many:merchant_pic_mro;"`
